...
1. Customized TypeScript and frontend components to adapt the user interface for our platform layout.
2. Removed default branding elements and external news feed integrations. 
---  How to Build and Run with Docker  To run this modified version of Grafana, you need to build the Docker image using the Dockerfile located in the root directory. 
